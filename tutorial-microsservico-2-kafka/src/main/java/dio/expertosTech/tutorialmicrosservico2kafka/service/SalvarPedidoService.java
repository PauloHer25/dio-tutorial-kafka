package dio.expertosTech.tutorialmicrosservico2kafka.service;
import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import dio.expertosTech.tutorialmicrosservico2kafka.data.PedidoData;
...
public class SalvarPedidoService {
    ...
    private void executar (ConsumerRecord<String, String> record) {
        ...
        try {
            ...
            log.error("Falha ao converter o evento[dado={}}]", strDados, ex);
            return;
        }
